...
import Myimg from "../../assets/images/Myimg5.png";
        ...
        <div className="md:flex items-center justify-between sm:flex-col md:flex-row">
          ...
          <div className="w-full md:basis-1/2">
            ...
            >
              ...
              A creative, challenge-driven and high-performing Individual<br/> with
              rapid learning abilities who enjoys Programming and <br/>software
              development.
            </p>
            <div className="flex items-center gap-9 mt-14">
              ...
              <span>
                <a
                  href="https://discord.com/channels/@sachinsargam#7810" target="blank"
